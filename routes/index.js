...
router.get('/ext/masternodelist', function(req, res) {
  db.get_masternodes(function(mnlist){
    res.send({ data: mnlist });
  });
});

router.get('/ext/dbsummary', function(req, res) {
      ...
      lib.get_connectioncount(function(connections){
        lib.get_blockcount(function(blockcount) {
          db.get_stats(settings.coin, function (stats) {
            ...
            lib.get_masternode_info(function(mninfo){
              
            db.get_avg_time(200, function(avg_time) {
            ...
            res.send({ data: [{
              ...
              masternodeinfo: mninfo,
              averageTime: avg_time.avg.toFixed(2),
              avgoverblocks: avg_time.obc
            }]});
            });
          });
          });
